...
.. only:: esp32p4
   ...
   This documentation for ESP32-P4 currently focuses on Flash Download Tool usage. It includes the user guide, frequently asked questions, related resources, and legal notices.

.. toctree::
   :hidden:
   :caption: Development Stage

   :not esp32p4: Introduction <development_stage/index>
   :not esp32p4: RF Test Guide <development_stage/rf_test_guide/rf_test_guide>
   :not esp32p4: RF Test Items <development_stage/rf_test_items/index>
   :not esp32p4: RF Test Certification <development_stage/rf_test_certification/index>
...
.. toctree::
   ...
   :not esp32p4: Introduction <production_stage/index>
   Flash Download Tool <production_stage/tools/flash_download_tool>
   :not esp32h2 and not esp32p4: Espressif Production Testing Guide <production_stage/tools/esp_production_testing_guide>
   :not esp32p4: Module Fixture Manufacturing Instructions <production_stage/instructions/test_fixture_mfg_inst>
